...
namespace SchoolApp.DAL.SchoolContext
{
    ...
    public class DbContextFactory : IDesignTimeDbContextFactory<SchoolDbContext>
    {
        public SchoolDbContext CreateDbContext(string[] args)
        {
            ...
            optionBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb; Database=SchoolSystemDbAfterStartingAngular; Trusted_Connection=True;  trust server certificate = true;");
