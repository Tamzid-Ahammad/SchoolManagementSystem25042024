...
@NgModule({
  declarations: [
    AppComponent,    
    MarksListComponent, MarksAddComponent, MarksEditComponent, MarksDeleteComponent, AttendanceListComponent, AttendanceAddComponent, FeeListComponent, FeeEditComponent, FeeCreateComponent, FeetypeListComponent, FeetypeEditComponent, FeetypeCreateComponent, MonthlypaymentListComponent, MonthlypaymentEditComponent, MonthlypaymentDetailsComponent, MonthlypaymentCreatComponent, StaffListComponent, ExamtypeListComponent, ExamtypeAddComponent, ExamtypeEditComponent,  ExamscheduleAddComponent, ExamscheduleEditComponent, ExamscheduleListComponent, ExamScheduleStandardsCreateComponent, ExamScheduleStandardsEditComponent, ExamScheduleStandardsListComponent, ExamSubjectCreateComponent, ExamSubjectEditComponent, ExamSubjectListComponent
